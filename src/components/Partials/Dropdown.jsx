...
const Dropdown = ({ deleteItem, toggleModal, modalState, rel }) => {
    ...
    return (
                ...
                <DeleteIcon />Delete</ActionButtonStyled>
            {
                modalState === 'delete' && <Modal toggleModal={toggleModal} title={`Delete ${rel === 'cities' ? 'city' : 'department'} `}
                    children={`All material and information about ${rel === 'cities' ? 'city' : 'department'} will be discarded`} actions={<ActionContainerStyled>
